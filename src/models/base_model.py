...
FEATURE_COLS = [
    ...
    # Elo rating (replaces all-time win rate)
    ...
    # Venue pitch features (now recent rolling average)
    "venue_avg_score", "venue_toss_impact", "venue_size",
    # Team overall batting/bowling strength
    "t1_batting_str", "t2_batting_str", "batting_str_diff",
    "t1_bowling_str", "t2_bowling_str", "bowling_str_diff",
    # Phase specific strengths
    "t1_pp_batting", "t2_pp_batting", "pp_batting_diff",
    "t1_death_bowling", "t2_death_bowling", "death_bowling_diff",
]
